...
int32_t main(int32_t argc, char **argv) {
    ...
    double argv_time_2OF3_v2m2 = 0.0;
    ...
    for (int trial = 0; trial < nb_trials; ++trial)
    {
        ...
        int32_t mess3_dec = MKbootsSymDecrypt(test_in3, MKlwekey);
        cout << "Message 1: clear = " << mess1 << ", decrypted = " << mess1_dec << endl;
        cout << "Message 2: clear = " << mess2 << ", decrypted = " << mess2_dec << endl;
        cout << "Message 3: clear = " << mess3 << ", decrypted = " << mess3_dec << endl;
        ...
        // evaluate MK bootstrapped 2OF3 
        cout << "Starting MK bootstrapped 2OF3 FFT version 2 method 2: trial " << trial << endl;
        clock_t begin_2OF3_v2m2 = clock();
        MKboots2OF3(test_out_v2m2, test_in1, test_in2, test_in3, MKlweBK_FFT, LWEparams, extractedLWEparams, RLWEparams, MKparams, MKrlwekey);
        clock_t end_2OF3_v2m2 = clock();
        double time_2OF3_v2m2 = ((double) end_2OF3_v2m2 - begin_2OF3_v2m2)/CLOCKS_PER_SEC;
        cout << "Finished MK bootstrapped 2OF3 FFT v2m2" << endl;
        cout << "Time per MKboot2OF3_FFT gate v2m2 (seconds)... " << time_2OF3_v2m2 << endl;

        argv_time_2OF3_v2m2 += time_2OF3_v2m2;

        // verify 2OF3
        int32_t out2OF3_v2m2 = MKbootsSymDecrypt(test_out_v2m2, MKlwekey);
        cout << "2OF3: clear = " << out << ", decrypted = " << out2OF3_v2m2 << endl;
        if (out2OF3_v2m2 != out) {
            error_count_v2m2 +=1;
    ...
    cout << "Average time per boot2OF3_FFT_v2m2: " << argv_time_2OF3_v2m2/nb_trials << " seconds" << endl;
